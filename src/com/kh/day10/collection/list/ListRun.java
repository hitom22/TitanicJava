...
//		System.out.println("num : " + num);
	...
	public void objectExample() {
		...
		// Object를 쓴 이유?
		// int를 쓰면 "월"을 못받고 String을 쓰면 "11"을 못받음
		
//		int num = obj;
		// "obj" error : Type mismatch: cannot convert from Object to int
		
		int num = (int)obj;
		
		Object obj2 = objList.get(1);
		String str = (String)obj2;
		// "obj2" error : Type mismatch: cannot convert from Object to String
		char cOne = (char)objList.get(2);
		// "objList.get(2)" error : Type mismatch: cannot convert from Object to char
	}
...
//		int result = nums[0];
		int result1 = nums.get(0); // 베열에다 직접 넣는것x // 메소드를 이용
